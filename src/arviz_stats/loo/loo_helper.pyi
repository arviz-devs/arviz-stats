...
def _get_log_likelihood_i(
    log_likelihood: xr.DataArray, i: Incomplete, obs_dims: list
) -> None: ...
...
def _align_group(
    group: xr.Dataset, observed: xr.DataArray, primary_obs_dim: str
) -> None: ...
...
def _warn_pareto_k(
    pareto_k_values: xr.DataArray, n_samples: int, suppress: bool = ...
) -> None: ...
