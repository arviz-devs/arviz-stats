...
def _kfold_split_random(k: int = ..., n: int | None = ...) -> None: ...
def _kfold_split_stratified(k: int = ..., x: ArrayLike | None = ...) -> None: ...
def _kfold_split_grouped(k: int = ..., x: ArrayLike | None = ...) -> None: ...
