...
def summary(
    ...
    skipna: bool = ...,
) -> SummaryDataFrame | pandas.DataFrame | Dataset: ...
def _build_fmt_map(
...
class SummaryDataFrame(pd.DataFrame):  # type: ignore[misc]
    ...
    def to_html(self, *args: Incomplete, **kwargs: Incomplete) -> str | None: ...
    def to_latex(self, *args: Incomplete, **kwargs: Incomplete) -> str | None: ...
    def __repr__(self) -> str: ...
    def __str__(self) -> str: ...
    def to_string(self, *args: Incomplete, **kwargs: Incomplete) -> str | None: ...
