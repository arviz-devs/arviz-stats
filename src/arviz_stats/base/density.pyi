...
class _DensityBase(_CoreBase):
    bw_methods_linear: Incomplete

    def dct1d(self, x: ArrayLike) -> ArrayLike: ...
    def _fixed_point(
        self, t: Incomplete, n: Incomplete, k_sq: Incomplete, a_sq: Incomplete
    ) -> None: ...
    def _root(
        self,
        function: Incomplete,
    ...
    def _normalize_angle(self, x: Incomplete, zero_centered: Incomplete = ...) -> None: ...
    def _vonmises_pdf(self, x: Incomplete, mu: Incomplete, kappa: Incomplete) -> None: ...
    def _a1inv(self, x: Incomplete) -> None: ...
    def _kappa_mle(self, x: Incomplete) -> None: ...
    ...
    def _qds(
        self,
        x: Incomplete,
        nquantiles: Incomplete,
        binwidth: Incomplete,
        dotsize: Incomplete,
        stackratio: Incomplete,
        top_only: Incomplete,
    ) -> None: ...
    def _ecdf(self, ary: Incomplete, npoints: Incomplete, pit: Incomplete) -> None: ...
    @staticmethod
    def _shapley_mean(values: Incomplete) -> None: ...
    def _pot_c(self, ary: Incomplete) -> None: ...
    def _prit_c(self, ary: Incomplete) -> None: ...
    def _piet_c(self, ary: Incomplete) -> None: ...
    def _mtc_c(self, ary: ArrayLike) -> tuple[float, NDArray, NDArray]: ...
    def _cauchy_combination(
        self, ps: Incomplete, cauchy_vals: Incomplete, truncate: Incomplete
    ) -> None: ...
