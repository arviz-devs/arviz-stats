...
class _DensityBase(_CoreBase):
    ...
    def dct1d(self, x: ArrayLike) -> NDArray: ...
    def _fixed_point(
    ...
    def bw_scott(
        self, x: ArrayLike, x_std: float | None = ..., **kwargs: Incomplete
    ) -> float: ...
    def bw_silverman(
        self, x: ArrayLike, x_std: float | None = ..., **kwargs: Incomplete
    ) -> float: ...
    ...
    def _normalize_angle(self, x: ArrayLike, zero_centered: bool = ...) -> NDArray: ...
    def _vonmises_pdf(self, x: ArrayLike, mu: float, kappa: float) -> NDArray: ...
    def _a1inv(self, x: float) -> float: ...
    ...
    def _ecdf(
        self, ary: ArrayLike, npoints: int, pit: bool
    ) -> tuple[np.ndarray, np.ndarray]: ...
    @staticmethod
    def _shapley_mean(values: ArrayLike) -> NDArray: ...
