...
class _CoreBase:
    ...
    def rfft(self, ary: ArrayLike, n: int, axis: int = ...) -> ArrayLike: ...
    def irfft(self, ary: ArrayLike, n: int, axis: int = ...) -> ArrayLike: ...
    def autocov(self, ary: ArrayLike, axis: int = ...) -> ArrayLike: ...
    def autocorr(self, ary: ArrayLike, axis: int = ...) -> ArrayLike: ...
