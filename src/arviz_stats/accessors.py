...
class _BaseAccessor:
    ...
    def eti(self, prob=None, dim=None, **kwargs):
        ...
        -------
        xarray.Dataset
            The equal-tailed intervals for all variables in the dataset.
        """
        kwargs["prob"] = prob
    ...
    def hdi(self, prob=None, dim=None, **kwargs):
        ...
        -------
        xarray.Dataset
            The highest density intervals for all variables in the dataset.
        """
        kwargs["prob"] = prob
    ...
    def ess(self, sample_dims=None, method="bulk", relative=False, prob=None, **kwargs):
        ...
        -------
        xarray.Dataset
            The effective sample size for all variables in the dataset.
        """
        return self._apply(
    ...
    def rhat(self, sample_dims=None, method="rank", **kwargs):
        ...
        -------
        xarray.Dataset
            The R-hat diagnostic for all variables in the dataset.
        """
    ...
    def rhat_nested(self, sample_dims=None, method="rank", superchain_ids=None, **kwargs):
        ...
        -------
        xarray.Dataset
            The nested R-hat diagnostic for all variables in the dataset.
        """
        return self._apply(
            "rhat_nested",
    ...
    def mcse(self, sample_dims=None, method="mean", prob=None, **kwargs):
        ...
        -------
        xarray.Dataset
            The Monte Carlo standard error for all variables in the dataset.
        """
    ...
    def qds(self, dim=None, **kwargs):
        ...
        -------
        xarray.Dataset
            The quantile dots for all variables in the dataset.
        """
    ...
    def get_bins(self, dim=None, **kwargs):
        ...
        -------
        xarray.Dataset
            The histogram bin edges for all variables in the dataset.
        """
    ...
    def histogram(self, dim=None, **kwargs):
        ...
        -------
        xarray.Dataset
            The histogram for all variables in the dataset.
        """
    ...
    def compute_ranks(self, dim=None, relative=False, **kwargs):
        ...
        -------
        xarray.Dataset
            The ranks for all variables in the dataset.
        """
    ...
    def ecdf(self, dim=None, **kwargs):
        ...
        -------
        xarray.Dataset
            The empirical CDF for all variables in the dataset.
        """
    ...
    def uniformity_test(self, dim=None, method="pot_c", **kwargs):
        ...
        -------
        xarray.Dataset
            The pointwise uniformity test values for all variables in the dataset.
        """
    ...
    def mchain_uniformity_test(self, dim=None, **kwargs):
        ...
        -------
        xarray.Dataset
            The multi-chain uniformity test values for all variables in the dataset.
        """
    ...
    def pareto_min_ss(self, sample_dims=None, **kwargs):
        ...
        -------
        xarray.Dataset
            The minimum sample size for all variables in the dataset.
        """
    ...
    def psislw(self, dim=None, **kwargs):
        ...
        Returns
        -------
        log_weights, khat : xarray.Dataset
            The smoothed log weights and the estimated Pareto shape parameter
    ...
    def bfmi(self, sample_dims=None, **kwargs):
        ...
        -------
        xarray.Dataset
            The estimated Bayesian fraction of missing information for all variables
            in the dataset.
        """
    ...
    def pareto_khat(self, sample_dims=None, **kwargs):
        ...
        -------
        xarray.Dataset
            The Pareto k-hat diagnostic for all variables in the dataset.
        """
    ...
    def loo(self, sample_dims=None, r_eff=1.0, log_weights=None, pareto_k=None, log_jacobian=None):
        ...
        Returns
        -------
        elpd_i, pareto_k, p_loo_i : xarray.Dataset
            The pointwise expected log pointwise predictive density, the Pareto shape
            estimates and the effective number of parameters for all variables in the dataset.
        """
        return self._apply(
            "loo",
            sample_dims=sample_dims,
    ...
    def loo_mixture(self, sample_dims=None, log_jacobian=None):
        ...
        -------
        xarray.Dataset
            The pointwise expected log pointwise predictive density for all variables
            in the dataset.
        """
        return self._apply(
            "loo_mixture",
    ...
    def loo_score(
        ...
        **kwargs,
        ...
        -------
        xarray.Dataset
            The CRPS or SCRPS scores for all variables in the dataset.
        """
        return self._apply(
            "loo_score",
            y_obs=y_obs,
    ...
    def loo_pit(
        ...
        **kwargs,
        ...
        -------
        xarray.Dataset
            The LOO-PIT values for all variables in the dataset.
        """
        return self._apply(
            "loo_pit",
            y_obs=y_obs,
    ...
    def loo_expectation(
        ...
        **kwargs,
        ...
        -------
        xarray.Dataset
            The weighted expectation for all variables in the dataset.
        """
        return self._apply(
            "loo_expectation",
            log_ratios=log_ratios,
    ...
    def loo_quantile(
        ...
        **kwargs,
        ...
        -------
        xarray.Dataset
            The weighted quantile for all variables in the dataset.
        """
        return self._apply(
            "loo_quantile",
            log_ratios=log_ratios,
    ...
    def loo_summary(self, p_loo_i):
        ...
        -------
        xarray.Dataset
            The aggregated pointwise LOO values for all variables in the dataset.
        """
    ...
    def loo_r2(
        ...
        **kwargs,
        ...
        -------
        xarray.Dataset
            The LOO-adjusted :math:`R^2` for all variables in the dataset.
        """
        return self._apply(
            "loo_r2",
            ypred_loo=ypred_loo,
    ...
    def power_scale_lw(self, dim=None, **kwargs):
        ...
        -------
        xarray.Dataset
            The power-scaling log weights for all variables in the dataset.
        """
    ...
    def power_scale_sense(self, sample_dims=None, **kwargs):
        ...
        -------
        xarray.Dataset
            The power-scaling sensitivity for all variables in the dataset.
        """
    ...
    def autocorr(self, dim=None, **kwargs):
        ...
        -------
        xarray.Dataset
            The autocorrelation for all variables in the dataset.
        """
    ...
    def mean(self, dim=None, **kwargs):
        ...
        -------
        xarray.Dataset
            The mean for all variables in the dataset.
        """
    ...
    def median(self, dim=None, **kwargs):
        ...
        -------
        xarray.Dataset
            The median for all variables in the dataset.
        """
    ...
    def mode(self, dim=None, **kwargs):
        ...
        -------
        xarray.Dataset
            The mode for all variables in the dataset.
        """
    ...
    def std(self, dim=None, **kwargs):
        ...
        -------
        xarray.Dataset
            The standard deviation for all variables in the dataset.
        """
    ...
    def var(self, dim=None, **kwargs):
        ...
        -------
        xarray.Dataset
            The variance for all variables in the dataset.
        """
    ...
    def mad(self, dim=None, **kwargs):
        ...
        -------
        xarray.Dataset
            The median absolute deviation for all variables in the dataset.
        """
    ...
    def iqr(self, dim=None, **kwargs):
        ...
        -------
        xarray.Dataset
            The interquantile range for all variables in the dataset.
        """
    ...
    def srs_estimator(self, n_data_points, **kwargs):
        ...
        -------
        xarray.Dataset
            The simple random sampling estimate for all variables in the dataset.
        """
        return self._apply(
            "srs_estimator",
    ...
    def diff_srs_estimator(
        ...
        **kwargs,
        ...
        -------
        xarray.Dataset
            The difference estimator for all variables in the dataset.
        """
        return self._apply(
            "diff_srs_estimator",
...
class AzStatsDsAccessor(_BaseAccessor):
    ...
    def ds(self):
        ...
        -------
        xarray.Dataset
            The Dataset wrapped by this accessor.
        """
        return self._obj
    ...
    def thin_factor(self, **kwargs):
        ...
        -------
        int
            The thinning factor aggregated across all variables in the dataset.
        """
    ...
    def thin(self, sample_dims=None, factor="auto"):
        ...
        -------
        xarray.Dataset
            The thinned variables of the dataset.
        """
        if factor == "auto":
...
class AzStatsDtAccessor(_BaseAccessor):
    ...
    def datatree(self):
        ...
        -------
        xarray.DataTree
            The DataTree wrapped by this accessor.
        """
        return self._obj
    ...
    def filter_vars(self, group="posterior", var_names=None, filter_vars=None):
        ...
        -------
        AzStatsDtAccessor
            This method returns the accessor after filtering the variables of the
            provided group.
        """
    ...
    def thin_factor(self, group="posterior", **kwargs):
        ...
        -------
        int
            The thinning factor aggregated across all variables in the group.
        """
    ...
    def thin(self, sample_dims=None, group="posterior", **kwargs):
        ...
        -------
        xarray.DataTree
            The thinned variables of the requested group.
        """
